...
namespace TetriNET2.Admin.ConsoleApp
{
    class Program
    {
                ...
                if (Console.KeyAvailable)
                {
                    ...
                    switch (cki.Key)
                    {
                        ...
                        case ConsoleKey.X:
                            ...
                            break;
                        case ConsoleKey.A:
                            admin.AdminGetAdminList();
                            break;
                        case ConsoleKey.C:
                            admin.AdminGetClientList();
                            break;
                        case ConsoleKey.R:
                            admin.AdminGetRoomList();
                            break;
                        case ConsoleKey.B:
                            admin.AdminGetBannedList();
                            break;
                        case ConsoleKey.S:
                            admin.AdminRestartServer(90);
                            break;
                    }
                }
                else
        ...
        //    {
        //        UpdateCallInfo(System.Reflection.MethodBase.GetCurrentMethod().Name, adminId, name, address);
        //    }
