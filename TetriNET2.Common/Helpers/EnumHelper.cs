...
namespace TetriNET2.Common.Helpers
{
    public static class EnumHelper
    {
        ...
        public static bool IsRuleReadonly(GameRules rule)
        {
            GameRuleAttribute attribute = GetAttribute<GameRuleAttribute>(rule);
            return attribute != null && attribute.AreOccurancesReadonly;
        }
